...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\eng.Hagar Ahmed\amdad\public\storage' => 'string',
...
'app.aliases.Vite','app.locales','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\eng.Hagar Ahmed\\amdad\\public\\storage','logging.default',
...
'web','api',);
        registerArgumentsSet('routes', 'login','login','login.google',
'login.facebook','register.supplier','register','otp.verify.show',
'otp.verify.submit','otp.resend','otp.switch.method','logout','profile',
'profile.show','profile.updateDetails','profile.updatePassword','home','search',
'products.index','products.filterByCategory','change.language','privacy',
'terms','common_questions','storage.local',);
        registerArgumentsSet('views', 
'common_questions','layouts.app','partials.customerReg','partials.footer','partials.header',
'partials.heroSection','partials.login','partials.otp','partials.supplierReg','privacy',
'profile.account','search.results','terms','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','messages.login','messages.Search',
'messages.Language','messages.Deliver to','messages.Riyadh','messages.All','messages.Electronics',
'messages.register','messages.deliver','messages.deliverySite','messages.deliverySiteMSG','messages.addLocation',
'messages.or','messages.chooseCity','messages.products','messages.suppliers','messages.english',
'messages.arabic','messages.return','messages.confirmLocation','messages.locationconfirmedmsg','messages.selectedLocation',
'messages.dragPhoto','messages.attachFile','messages.imageURL','messages.wholesale','messages.reliableSolution',
'messages.heroDsecription','messages.shopNow','messages.password','messages.confirmPassword','messages.email',
'messages.phone','messages.address','messages.loginMSG','messages.passwordMSG','messages.remember_me',
'messages.forgot_password','messages.login_with_google','messages.login_with_facebook','messages.dont_have_account','messages.create__new_account',
'messages.registerMSG','messages.login_success','messages.login_failed','messages.register_success','messages.register_failed',
'messages.logout','messages.supplier','messages.customer','messages.account_data','messages.full_name',
'messages.company_name','messages.phone_number','messages.nameMSG','messages.phoneMSG','messages.confirm_password',
'messages.confirm_passwordMSG','messages.accept_terms','messages.terms_and_conditions','messages.privacy_policy','messages.and',
'messages.already_have_account','messages.company_nameMSG','messages.complete_data','messages.nameError','messages.emailError',
'messages.emailValid','messages.emailUnique','messages.passwordMin','messages.passwordString','messages.passwordConfirm',
'messages.passwordNumber','messages.bussniss_data','messages.national_id','messages.national_idMSG','messages.attach',
'messages.file_format','messages.commercial_registration','messages.commercial_registrationMSG','messages.commercial_reg_or_certificate','messages.national_address',
'messages.national_addressMSG','messages.national_address_attach','messages.iban','messages.ibanMSG','messages.iban_attach',
'messages.tax_certificate','messages.tax_certificateMSG','messages.tax_certificate_attach','messages.otpLoginRequired','messages.footer_description',
'messages.fast_links','messages.home','messages.favorites','messages.cart','messages.categoris',
'messages.clothing','messages.Office_supplies','messages.electrical-appliances','messages.browse_all_categories','messages.important_informations',
'messages.common_questions','messages.login_as_supplier','messages.add_product','messages.phone_number_Unique','messages.not_recieve',
'messages.resend','messages.use_phone_instead','messages.use_email_instead','messages.confirm','messages.search_with',
'messages.recent_Searches','messages.contact_us','messages.contactUs','messages.contactDescription','messages.mailMessage',
'messages.selectExplanation','messages.expType','messages.msg','messages.send','messages.writeQuestion',
'messages.MyAccount','messages.MyOrders','messages.Fav','messages.settings_notifications','messages.previous',
'messages.satisfied_customers','messages.fast_deliver','messages.all','messages.categories','messages.recommend',
'messages.refresh','messages.delete','messages.failed_email','messages.incorrect_password','messages.passwordRegex',
'messages.phone_number_max','messages.Register',);
...
'CACHE_STORE','CACHE_DRIVER','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
...
'VITE_APP_NAME','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',);
