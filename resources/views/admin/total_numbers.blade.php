  <main class="flex-1 overflow-x-hidden overflow-y-auto p-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow p-6 flex items-center justify-between">
                    ...
                    <i class="fas fa-user-friends text-4xl text-green-500 opacity-20"></i>
                </div>
                ...
                <div class="bg-white rounded-xl shadow p-6 flex items-center justify-between">
                    ...
                    <i class="fas fa-store text-4xl text-green-500 opacity-20"></i>
                </div>
                ...
                <div class="bg-white rounded-xl shadow p-6 flex items-center justify-between">
                    ...
                    <i class="fas fa-file-alt text-4xl text-green-500 opacity-20"></i>
                </div>
            </div>
