...
<h2 class="text-[28px] font-bold mb-6"> تعديل النص</h2>
...
action="{{ isset($siteText) ? route('admin.site_texts.update', $siteText->id) : route('admin.site_texts.store') }}" method="POST">
    @csrf
    @if(isset($siteText))
        @method('PUT')
    @endif
