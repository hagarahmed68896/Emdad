  ...
  <div dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}"
    ...
    <div class="w-full md:w-1/2 bg-[#185D31] p-8 md:p-12 flex flex-col justify-center items-center text-white overflow-auto">
        <div class="w-full max-w-md bg-white rounded-xl p-4 shadow-lg mb-4">
            <img src="/images/cd11071e9281b541cdbadadda2e9d1fcb71ad2cb.png"
                 alt="Dashboard Preview" class="w-full h-auto rounded-lg">
        </div>
        <h2 class="text-4xl font-bold text-center mb-6">{{ __('messages.welcome_dashboard') }}</h2>
        <p class="text-center text-green-100 mb-8 max-w-md">{{ __('messages.dashboard_description') }}</p>
    </div>
    ...
    <div class="w-full md:w-1/2 p-8 md:px-[60px] flex flex-col overflow-auto" x-data="adminLogin()">
        ...
        <div class="p-[64px]">
            <h2 class="text-3xl font-bold text-gray-800 mb-2">{{ __('messages.login') }}</h2>
            <p class="text-gray-600 mb-8">{{ __('messages.login_description') }}</p>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div x-data="{ show: false }" class="relative">
                    <label class="block mb-2">{{ __('messages.password') }}</label>
                ...
                <div class="flex justify-between items-center mt-2">
                    <label class="inline-flex items-center">
                        ...
                        <span class="mr-2">{{ __('messages.remember_me') }}</span>
                    </label>
                    ...
                    <div x-data="{ showForgotPassword: false, forgotEmail: '', forgotMessage: '' }" x-cloak class="inline">
                        ...
                        <div x-show="showForgotPassword" x-transition.opacity
                            ...
                            <div @click.away="showForgotPassword = false"
                                ...
                                <h2 class="text-lg font-bold mb-4">{{ __('messages.reset_password') }}</h2>
                                <p class="text-gray-600 mb-4">{{ __('messages.reset_password_instructions') }}</p>
                                ...
                                <div class="flex justify-center gap-4">
                                    <button type="button" @click="sendResetLink()"
