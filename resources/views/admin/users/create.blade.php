...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
    <div x-data="createUserForm()" class="bg-white rounded-xl shadow p-6 mx-auto">
        ...
        <template x-if="Object.keys(errors).length">
            <ul class="bg-red-100 border border-red-400 text-red-700 p-4 rounded mb-4 list-disc list-inside">
                <template x-for="([key, messages]) in Object.entries(errors)" :key="key">
            ...
            async submitForm() {
                ...
                try {
                    ...
                    if (!response.ok) {
                        ...
                        this.success = data.success || '✅ تم إضافة المستخدم بنجاح';
                        setTimeout(() => {
