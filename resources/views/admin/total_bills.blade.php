    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow p-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm">{{ __('messages.total_invoices') }}</p>
        ...
        <div class="bg-white rounded-xl shadow p-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm">{{ __('messages.paid_invoices') }}</p>
                <p class="text-[#185D31] text-sm flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                    </svg>
        ...
        <div class="bg-white rounded-xl shadow p-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm">{{ __('messages.unpaid_invoices') }}</p>
