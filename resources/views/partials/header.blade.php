...
<header class="bg-white flex flex-wrap items-center justify-between py-3 shadow-md h-auto w-full md:px-[64px] px-[20px]">
    ...
    <button id="dropdownMenuIconButton" data-dropdown-toggle="dropdownDots"
        class="hidden order-3  items-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 "
        type="button">
