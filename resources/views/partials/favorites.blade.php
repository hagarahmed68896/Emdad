                        ...
                        <div class="product-card bg-white rounded-xl overflow-hidden shadow-md flex flex-col">
                            ...
                            <div class="p-4 flex flex-col flex-grow">
                                <div class="flex w-full items-center text-sm mb-2 justify-between">
                                    <h3 class="text-[24px] font-bold text-[#212121] mb-1">{{ $favorite->product->name }}
                                    </h3>
                                    ...
                                    @if ($favorite->product->supplier->supplier_confirmed)
                                        <span class="flex items-center text-[#185D31]">
                                            ...
                                            <p class="text-[20px] text-[#212121] ">
                                                {{ $favorite->product->supplier->company_name }}</p>
                                        </span>
                                    @else
                                        <p class="text-[20px] text-[#212121]">{{ $favorite->product->supplier->company_name }}
                                        </p>
                                    @endif
                                </div>
            ...
            fetch(`/products/${productId}/toggle-favorite`, {
                ...
                .then(data => {
                    ...
                    if (data.is_favorited) {
                        ...
                        if (window.location.pathname.includes('/favorites') || window.location.pathname
                            .includes('/profile/account')) {
                            if (card) {
                                ...
                                const remainingCardsOnPage = document.querySelectorAll('.product-card')
                                    .length;
                                ...
                                if (remainingCardsOnPage === 0) {
                                    ...
                                    if (pageParam && parseInt(pageParam) > 1) {
                                        newPageUrl +=
                                        `?page=${parseInt(pageParam) - 1}`; // Go to previous page
                                    }
