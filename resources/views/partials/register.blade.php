...
<div x-data="{ showLogin: false, showRegister: false, userType: 'customer', accountData: true, bussnissdata: false }">
                            ...
                            <div class="mb-3" x-data="{ password: '', confirmPassword: '', showPassword: false }">
                                ...
                                <div
                                    ...
                                    <input :type="showPassword ? 'text' : 'password'" name="password_confirmation"
                                        required placeholder="{{ __('messages.confirm_passwordMSG') }}"
                        ...
                        <div x-show="bussnissdata" class="mt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div x-data="{ fileUpload: null }" class=" mt-2">
                                    ...
                                    <div
                                        ...
                                        <input type="text" name="national_id_attach" readonly id="fileName"
                            ...
                            <div class="mb-4">
                                ...
                                <div x-data="{ fileUploadCom: null }" class=" mt-2">
                                    ...
                                    <div
                                        class="flex item-center mt-2 h-[56px] border-[1px] border-[#767676] rounded-[12px] overflow-hidden">
                                        <input type="text" name="commercial_registration_attach" readonly
                                        ...
                                        <div
                                            ...
                                            <input type="file" id="fileUploadCom" class="hidden"
                                                name="commercial_registration_attach" accept="image/*,application/pdf"
                            ...
                            <div class="mb-4">
                                ...
                                <div x-data="{ fileUploadadd: null }" class=" mt-2">
                                    ...
                                    <div
                                        class="flex item-center mt-2 h-[56px] border-[1px] border-[#767676] rounded-[12px] overflow-hidden">
                                        <input type="text" name="national_address_attach" readonly
                                        ...
                                        <div
                                            ...
                                            <input type="file" id="fileUploadadd" class="hidden"
                                                name="national_address_attach" accept="image/*,application/pdf"
                            ...
                            <div class="mb-4">
                                ...
                                <div x-data="{ fileUploadIBAN: null }" class=" mt-2">
                                    ...
                                    <div
                                        class="flex item-center mt-2 h-[56px] border-[1px] border-[#767676] rounded-[12px] overflow-hidden">
                                        <input type="text" name="iban_attach" readonly
                            ...
                            <div class="mb-4">
                                ...
                                <div x-data="{ fileUploadTax: null }" class=" mt-2">
                                    ...
                                    <div
                                        class="flex item-center mt-2 h-[56px] border-[1px] border-[#767676] rounded-[12px] overflow-hidden">
                                        <input type="text" name="tax_certificate_attach" readonly
