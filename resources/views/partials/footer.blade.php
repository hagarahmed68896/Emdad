    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 justify-between">
        <div class="flex flex-col items-center text-center md:items-start md:text-right">
            ...
            <div class="flex space-x-4 rtl:space-x-reverse justify-center md:justify-start">
                ...
                <a href="{{ $socials['linkedin'] }}" target="_blank"
                    class="text-[#185D31] bg-white rounded-full p-2 transition-colors duration-300">
        ...
        <div class="text-center md:text-right">
            ...
            <ul>
                <li class="mb-2"><a href="#"
                        class="hover:text-white transition-colors duration-300">{{__('messages.home')}}</a></li>
                <li class="mb-2"><a href="{{ route('products.index') }}"
                        class="hover:text-white transition-colors duration-300">{{__('messages.products')}}</a></li>
                <li class="mb-2">
        ...
        <div class="text-center md:text-right">
            ...
            <ul>
                ...
                <li class="mb-2">
                    <a href="{{ route('products.filterByCategory', $category->slug) }}" class="hover:text-white transition-colors duration-300
        ...
        <div class="text-center md:text-right">
            <h4 class="font-bold text-lg mb-2 underline">{{__('messages.help_support')}}</h4>
            <ul>
     <li class="mb-2">
                ...
                <li>
                    @auth
                    <a href="{{ route('tickets.index') }}" class="hover:text-white transition-colors duration-300">
                        {{ __('messages.tech_support') }}
                    </a>
                    @else
                    <div x-data="{ show: false }" class="relative flex-1">
                        <a href="javascript:void(0)" @click="show = true; setTimeout(() => show = false, 3000)"
                            class="hover:text-white transition-colors duration-300">
                            {{ __('messages.tech_support') }}
                        </a>
        ...
        {{-- <div class="text-center md:text-right">
            ...
            <ul>
                <li class="mb-2"><a href="#"
                        class="hover:text-white transition-colors duration-300">{{__('messages.login_as_supplier')}}</a>
                </li>
                <li class="mb-2">
